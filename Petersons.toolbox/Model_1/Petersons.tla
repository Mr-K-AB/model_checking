...
FairSpec == ( Init /\ [][Next]_vars /\ WeakFairness)
...
BOUNDEDWAIT0 == []( (state0=5) => <> (state0=7) )
BOUNDEDWAIT1 == []( (state1=5) => <> (state1=7) )


=============================================================================
\* Modification History
\* Last modified Wed Sep 21 18:23:42 IST 2022 by mr_ab
