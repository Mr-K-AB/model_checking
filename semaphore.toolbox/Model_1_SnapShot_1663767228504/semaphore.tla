...
P_22 == (stateP=2 /\ sem=1 /\ stateP'=2)     /\ UNCHANGED<< sem >>
P_23 == (stateP=2 /\ sem=0 /\ sem'=1 /\ stateP'=3)     /\ UNCHANGED<<  >>
...
P == (P_0 \/ P_1 \/ P_23 \/ P_22 \/ P_3 \/ P_4 \/ P_5)
...
Q_22 == (stateQ=2 /\ sem=1 /\ stateQ'=2)     /\ UNCHANGED<< sem >>
Q_23 == (stateQ=2 /\ sem=0 /\ sem'=1 /\ stateQ'=3)     /\ UNCHANGED<<  >>
...
Q == (Q_0 \/ Q_1 \/ Q_23 \/ Q_22 \/ Q_3 \/ Q_4 \/ Q_5)
...
BOUNDEDWAIT0 == []( (stateQ=2) => (<> (stateQ=3) ) )
BOUNDEDWAIT1 == []( (stateP=2) => (<> (stateP=3) ) )


=============================================================================
\* Modification History
\* Last modified Wed Sep 21 19:02:15 IST 2022 by mr_ab
